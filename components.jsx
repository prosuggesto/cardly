...
const Icon = {
  ...
  Instagram: (p) => <svg width={p.size||16} height={p.size||16} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1.1" fill="currentColor" stroke="none"/></svg>,
  Linkedin: (p) => <svg width={p.size||16} height={p.size||16} viewBox="0 0 24 24" fill="currentColor"><path d="M19 3a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h14zM8.34 18.34V9.73H5.67v8.61h2.67zM7 8.58a1.55 1.55 0 100-3.1 1.55 1.55 0 000 3.1zm11.34 9.76v-4.72c0-2.31-1.24-3.4-2.88-3.4-1.33 0-1.93.74-2.26 1.25V9.73h-2.67c.04.75 0 8.61 0 8.61h2.67v-4.81c0-.24.02-.48.09-.65.19-.48.63-.98 1.37-.98.97 0 1.35.74 1.35 1.82v4.62h2.67z"/></svg>,
