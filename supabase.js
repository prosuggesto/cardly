    ...
    window.CardlyAPI = {
      ...
      carteToDBUpdate(card, { fieldColors = {}, fieldSides = {}, fieldSizes = {}, fieldFonts = {}, fieldDecorations = {}, logoUrl, logoSide, logoSizeRecto, logoSizeVerso, frontImageUrl, backImageUrl } = {}) {
        ...
        return {
          ...
          prenom_couleur:         fc.name       || '#2a241a',
          nom_couleur:            fc.name       || '#2a241a',
          nom_entreprise_couleur: fc.entreprise || '#2a241a',
          poste_couleur:          fc.poste      || '#2a241a',
          telephone_couleur:      fc.phone      || '#2a241a',
          email_couleur:          fc.email      || '#2a241a',
          site_web_couleur:       fc.web        || '#2a241a',
